...
$(document).ready(function() {
  ...
  $("#kachumbari").click(function() {
    $(".kachumbari").toggle();
  });
  $("#kaimati").click(function() {
    $(".kaimati").toggle();
  });
  $("#matoke").click(function() {
    $(".matoke").toggle();
  });
  $("#nyama").click(function() {
    $(".nyama").toggle();
  });
...
/** This is the demo javascript code for the Api **/
$(document).ready(function () {
 $.ajax({
  method: 'GET',
  url: '/api/recipes',
